...
// container size for shapes size
  ...
  double containerWidthForShapesType = 1.7;
  double containerHeightForShapesType = 1.15;
  double containerWidthForShapesData = 2.7;
  double containerHeightForShapesData = 1.10;
